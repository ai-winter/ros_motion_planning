...
#ifndef RMP_CONTROLLER_MPPI_COST_CRITIC_HPP_
#define RMP_CONTROLLER_MPPI_COST_CRITIC_HPP_
...
costmap_2d::InflationLayer* getInflationLayer(costmap_2d::Costmap2DROS* costmap_ros,
...
/**
 * @class rmp::controller::mppi::critics::CostCritic
...
protected:
   ...
   * @param costmap Costmap2DROS to get minimum inscribed cost (e.g. 128 in inflation
   * layer documentation)
   * @return double circumscribed cost, any higher than this and need to do full footprint
   * collision checking since some element of the robot could be in collision
   */
  inline float findCircumscribedCost(costmap_2d::Costmap2DROS* costmap);
  ...
  costmap_2d::FootprintCollisionChecker<costmap_2d::Costmap2D*> collision_checker_{
    nullptr
  };
...
#endif  // RMP_CONTROLLER_MPPI_COST_CRITIC_HPP_