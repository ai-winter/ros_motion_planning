 ...
 */
std::vector<double> CubicSplineCurve::spline(std::vector<double> s_list, std::vector<double> dir_list,
                                             std::vector<double> t)
{
 ...
 */
bool CubicSplineCurve::run(const Points2d points, Points2d& path)
{
  if (points.size() < 4)
    return false;
  else
 ...
 * @return true if generate successfully, else failed
 */
bool CubicSplineCurve::run(const Points3d points, Points2d& path)
{
  if (points.size() < 4)
  {
    return false;
